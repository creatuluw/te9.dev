...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const typeLabel = derived(() => data.meta._draftType === "skill" ? "Skill" : "Article");
    head("nonkpk", $$renderer2, ($$renderer3) => {
