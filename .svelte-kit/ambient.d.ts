...
declare module '$env/static/private' {
	...
	export const RAINDROP_CLIENT_ID: string;
	export const RAINDROP_CLIENT_SECRET: string;
	export const RAINDROP_REFRESH_TOKEN: string;
