 ...
 *
 * Provides direct SMTP email sending. This is a server-only module —
 * the emailjs dependency must never leak into the browser bundle.
 *
...
function getSmtpConfig() {
	return {
		...
		fromEmail: env.SMTP_FROM_EMAIL || "no-reply@te9.dev",
		fromName: env.SMTP_FROM_NAME || "te9.dev",
	};
}
