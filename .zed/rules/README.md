...
4. **@prd-execute** - Implement work (references `.opencode/skill/prd-execute/`)
5. **@prd-testing** - Verify criteria (references `.opencode/skill/prd-test/`)
6. **@prd-tracking** - Log progress (references `.opencode/skill/prd-track/`)
